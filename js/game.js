    ...
    var SantaGame = {
        ...
        load: {
            preload: function() {
                ...
                this.game.load.image('baobao', 'assets/baobao.png');
                this.game.load.image('haidi', 'assets/haidi.png');
            },
            create: function() {
        ...
        title: {
            create: function() {
                ...
                this.bg = this.game.add.tileSprite(0, 0, width, height, 'haidi').autoScroll(-100,0);
                this.logo = this.game.add.sprite(this.game.world.width / 2 - 158, 20, 'baobao');
        ...
        play: {
            create: function() {
                ...
                // this.music.play();
                this.bg_heaven = this.game.add.tileSprite(0, 0, width, height, 'snow-bg-2').autoScroll(-50,0);
                this.bg = this.game.add.tileSprite(0, 0, width, height, 'haidi');
